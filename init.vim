"先运行'curl -fLo ~/.local/share/nvim/site/autoload/plug.vim --create-dirs https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim'
"然后在nvim中执行':PluginInstall'
"参考：https://github.com/junegunn/vim-plug
"设置alias vi="nvim" alias vim="nvim"
